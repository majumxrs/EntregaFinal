...
namespace ProjetoFinal.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        {
            var contexto = _context.SaidaProduto
                .Include(s => s.Cliente)
                .Include(s => s.Produto)
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoSaidaId"] = new SelectList(_context.TipoSaida, "Id", "TipoSaidaIdDescricao");
        ...
        public async Task<IActionResult> Create([Bind("SaidaProdutoId,ProdutoId,DataSaida,QuantidadeSaida,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            if (ModelState.IsValid)
            {
                ...
                produto.Quantidadestoque = produto.Quantidadestoque - saidaProduto.QuantidadeSaida;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,UsuarioId,ProdutoId,QuantidadeSaida,DataSaida,TipoSaidaId")] SaidaProduto saidaProduto)
        {
