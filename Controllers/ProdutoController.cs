...
namespace ProjetoFinal.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,Quantidadestoque,FornecedorId,TipoProdutoId")] Produto produto)
        {
            produto.Quantidadestoque = 0;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoNome,Quantidadestoque,FornecedorId,TipoProdutoId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
