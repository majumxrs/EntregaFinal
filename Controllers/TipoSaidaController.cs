...
namespace ProjetoFinal.Controllers
{
    public class TipoSaidaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoSaidaIdDescricao")] TipoSaida tipoSaida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoSaidaIdDescricao")] TipoSaida tipoSaida)
        {
            if (id != tipoSaida.Id)
            {
                return NotFound();
